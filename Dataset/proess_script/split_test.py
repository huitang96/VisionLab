...
class BatchCopy():
    def __init__(self):
        ...
        self.newpath = '/home/htang/proj/datasets/VOCdevkit/VOC2007/test_annotations'
...
def loadFileList():
    filelist = []
    f = open("/home/htang/proj/datasets/VOCdevkit/VOC2007/ImageSets/Main/test.txt", "r")
    lines = f.readlines()
    for line in lines:
        line = line.strip('\r\n')  # to remove the '\n' for test.txt, '\r\n' for tainval.txt 
        line = str(line)
...
if __name__ == '__main__':
    demo = BatchCopy()
    demo.copy_file()
    filelist = os.listdir('/home/htang/proj/datasets/VOCdevkit/VOC2007/test_annotations')
    # print(len(filelist))
